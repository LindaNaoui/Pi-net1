            ...
            if (ModelState.IsValid)
            {
                ...
                try
                {
                    ...
                    if (img.ContentLength > 0)
                    {
                        ...
                        var user = new User { UserName = model.Email, Email = model.Email, img = Path1, role = model.role, firstname = model.firstname, lastname = model.lastname, PhoneNumber = model.PhoneNumber, birthday = model.birthday, Address = model.Address, gender = model.gender, country = model.country };
